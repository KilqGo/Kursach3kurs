...
options = ["Фестиваль Фей", "Вариант 2", "Вариант 3", "Вариант 4", "Вариант 5",
           "Вариант 6", "Вариант 7", "Вариант 8", "Вариант 9", "Вариант 10"]

info = {
    "Фестиваль Фей": "Это группа человекоподобных фей, состоящая из одной большой и кучи маленьких фей. У фей антропоморфное строение тела, аквамаринового цвета кожа, 2 пары рук, 3, если считать длинные, похожие на руки, волосы; пара ног, хвост, большие крылья насекомого и пара заостренных ушей на верхней части волос.",
